...
(function (factory) {
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '         {delete}<br/>IsMain: <input id="IsMain" style="vertical-align: bottom;"  type="radio" Value="{caption}" name="IsMain"/><script>FillColors();</script>' +
        '    </div>\n' +
        '    {drag}\n' +
    ...
    FileInput.prototype = {
        ...
        _slugDefault: function (text) {
            return text;
            //isEmpty(text) ? '' : String(text).replace(/[\-\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, '_');
        },
